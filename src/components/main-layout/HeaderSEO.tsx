...
export function HeaderSEO() {
  return <>
    ...
    <meta
      name="description"
      content="DexTools for Crypto Options Trading powered by AI"
    />

    <link rel="apple-touch-icon" sizes="152x152" href="/logo1-black-bg.png"/>
    <link rel="icon" type="image/png" sizes="32x32" href="/logo1.png"/>
    <link rel="icon" type="image/png" sizes="16x16" href="/logo1.png"/>
    <link rel="manifest" href="/site.webmanifest"/>
    <link rel="mask-icon" href="/logo1.png" color="#070321"/>
